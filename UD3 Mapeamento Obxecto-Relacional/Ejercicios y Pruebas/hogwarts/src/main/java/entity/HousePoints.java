...
@NamedQuery(
        name="personMaxPointsGiver",
        query="select max(hp.points), hp.personByGiver from HousePoints hp"
)
@NamedQuery(
        name= "personMaxPointsReciver",
        query = "select max(hp.points), hp.personByReceiver from HousePoints hp"
)
