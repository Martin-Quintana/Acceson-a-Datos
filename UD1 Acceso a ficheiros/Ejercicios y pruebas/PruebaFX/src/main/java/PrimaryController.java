...
public class PrimaryController {
    ...
    public String getWoeid() throws MalformedURLException {
        org.example.APIConnector apiConnectorCity = new org.example.APIConnector(cityAPI);
    ...
    public JSONObject GetTodaysWeatherInformation(String woeid) throws MalformedURLException {
        org.example.APIConnector apiConnectorWeather = new org.example.APIConnector(weatherAPI);
